...
function install(editor, _ref) {
  ...
  editor.on('renderconnection', function (_ref3) {
    ...
    path.addEventListener('dblclick', function () {
      ...
      var _editor$view$connecti3 = editor.view.connections.get(connection).getPoints(),
          _editor$view$connecti4 = _slicedToArray(_editor$view$connecti3, 4),
          x1 = _editor$view$connecti4[0],
          y1 = _editor$view$connecti4[1],
          x2 = _editor$view$connecti4[2],
          y2 = _editor$view$connecti4[3];
